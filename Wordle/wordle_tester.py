...
print(check_word('LERED', 'RADIO')) # ['yellow', 'grey', 'yellow', 'grey', 'grey']
print(check_word('LERED', 'DRUID')) # ['grey', 'yellow', 'grey', 'grey', 'green']
print(check_word('LERED', 'LERED')) # ['green', 'green', 'green', 'green', 'green']
print(check_word('PERIS', 'RAISE')) # ['yellow', 'grey', 'yellow', 'yellow', 'yellow']
print(check_word('OPENS', 'EPICS')) # ['yellow', 'green', 'grey', 'grey', 'green']
print(check_word('MISTS', 'MISTY')) # ['green', 'green', 'green', 'green', 'grey']
print(check_word('ELUDE', 'LEDGE')) # ['yellow', 'yellow', 'yellow', 'grey', 'green']
print(check_word('CRANE', 'BEEPS')) # ['grey', 'yellow', 'grey', 'grey', 'grey']
print(check_word('ROBOT', 'REORG')) # ['green', 'grey', 'yellow', 'grey', 'grey']
print(check_word('BOOKS', 'SHOES')) # ['grey', 'grey', 'green', 'grey', 'green']
...
original_words = words.copy() # we'll want to check if you're messing up the words list!
...
print(words == original_words) # True
print(len(result)) # 39
expected = ['miser', 'wires', 'siler', 'tiers', 'sider', 'sevir', 'siker', 'peris', 'speir', 'sizer', 'sweir', 'serir', 'meris', 'kiers', 'vires', 'tires', 'sehri', 'hires', 'fiers', 'cires', 'sieur', 'siver', 'biers', 'serif', 'fires', 'sixer', 'epris', 'liers', 'siren', 'serin', 'icers', 'piers', 'sired', 'sires', 'seric', 'viers', 'wiser', 'breis', 'mires']
...
clues = [('TUNES', ['yellow', 'green', 'green', 'grey', 'green'])]
result = filter_word_list(words, clues)
expected = ['munts', 'runts', 'lunts', 'punts', 'funts', 'sunts', 'aunts', 'cunts', 'hunts', 'bunts', 'dunts']
...
clues = [('RADIO', ['yellow', 'grey', 'yellow', 'grey', 'grey']),
         ('DRUID', ['grey', 'yellow', 'grey', 'grey', 'green'])]
result = filter_word_list(words, clues)
expected = ['gyred', 'cered', 'mered', 'spred', 'shred', 'sered', 'sherd', 'lered', 'tyred']
